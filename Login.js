            ...
            <div class="auth-form">
                <div class="auth-form__container">
                    <div class="auth-form__header">
                        ...
                        <span class="auth-form__switch-bth">Đăng nhập</span>
                    </div>

                    {/* <div class="auth-form__form">
                        <div class="auth-form__group">
                            <input type="text" class="auth-form__input" placeholder="Số email của bạn:">
                        </div>
                        <div class="auth-form__group">
            ...
            <div class="auth-form">
                <div class="auth-form__container">
                    <div class="auth-form__header">
                        ...
                        <span class="auth-form__switch-bth">Đăng ký</span>
                    </div>
                    ...
                    <div class="auth-form__aside">
                        <div class="auth-form__help">
                            ...
                            <a href="" class="auth-form__help-link">Cẩn trợ giúp ?</a>
                        </div>
                    </div>
